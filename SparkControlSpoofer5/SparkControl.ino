...
void SparkControlStart() {
    ...
    NimBLEAdvertisementData oScanAdvertisementData = NimBLEAdvertisementData();    
    
    char scan_data[] = {0x15, 0x09, 'S', 'K', 'C', '5', '0', 'S', '-', '4', ' ', 'v', '3', '.', '0', '.', '1',
      ' ','9', 'E', '0', '2',
      0x03, 0x19,
      0xc0, 0x03};
    char adv_data[] = {0x05, 0xff, 0x22, 0x01, 0x01, 0x1b, 
    ...
    oAdvertisementData.addData(adv_data, 24);
/*    
