...
#define BATTERY_OFF 3.60  // Voltage when we decide to force the pedal to switch to stand-by mode
#define BATTERY_FUDGE 3.65// Fudge factor to speed up initial averaging calcs
#define BATTERY_0 3.30    // Noise floor of 0%
#define BATTERY_6	3.68
#define BATTERY_60	3.87
